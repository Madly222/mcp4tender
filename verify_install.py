...
REQUIRED = [
    ...
    "web/user/settings_meta.py", "web/user/forms.py", "web/user/dictforms.py", "web/user/lifecycle.py", "web/user/sites_panel.py", "web/user/labels.py", "web/user/routes_planning.py",
    "web/settings_ops.py",
