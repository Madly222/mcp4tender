...
SYNONYMS = {
    ...
    "cost": ("dealer", "dealer b", "dealer usd", "dealer b, usd", "pret dealer",
             "preț dealer", "pret dealer usd", "preț dealer usd", "pret d", "preț d",
             "cost", "wholesale", "opt", "оптовая", "дилер", "закуп", "ценаd", "цена d",
             "ценаd, usd", "цена dealer", "цена диллер", "цена дилер", "ценаd usd",
             "pret d usd", "цена d, usd"),
